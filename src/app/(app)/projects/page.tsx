...
/**
 * Internal FH projects (FHP series — primer development, social
 * media, brand work, etc) split into a separate band so they don't
 * compete visually with paying-client engagements. Code prefix is the
 * discriminator; the three pure-overhead expense buckets (FHB / FHO
 * / FHX) are already filtered out by `listProjects`.
 */
