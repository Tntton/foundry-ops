      ...
      <header className="flex items-start justify-between gap-2">
        <div>
          ...
          <p className="text-sm text-ink-3">
            Money clients owe Foundry — approved, sent, partial, or overdue
            invoices, bucketed by days past due. Outstanding is total minus
            payments received, inc GST.
          </p>
        </div>
        <div className="flex flex-wrap items-center gap-2">
          {hasCapability(session, 'invoice.create') && (
            <Link
              href="/invoices/new"
              className="rounded-md bg-brand px-3 py-1.5 text-sm text-brand-ink hover:bg-brand/90"
            >
              + New project invoice
            </Link>
          )}
